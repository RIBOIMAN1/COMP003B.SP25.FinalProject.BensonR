...
namespace COMP003B.SP25.FinalProject.BensonR.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InvoiceId,PayStatus,PayType")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InvoiceId,PayStatus,PayType")] Invoice invoice)
        {
